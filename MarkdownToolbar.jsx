export default function MarkdownToolbar({ textareaRef, theme }) {
  ...
  const btnClass = `px-2 py-1 rounded text-xs font-medium transition border ${
    theme === 'dark'
  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5 mb-2">
      ...
      <span className="w-px h-4 bg-gray-500/30 mx-1" />
      ...
      <button type="button" onClick={insertImage} className={btnClass} title="Carica immagine">
        🖼 Img
      </button>
      <span className="w-px h-4 bg-gray-500/30 mx-1" />
